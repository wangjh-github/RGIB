...
def compute_ppr(a_hat, alpha=0.2, self_loop=True):
    return alpha * inv((np.eye(a_hat.shape[0]) - (1 - alpha) * a_hat))   # a(I_n-(1-a)A~)^-1
...
def mask_test_edges(adj):
    ...
    return adj_train.todense(), train_edges, val_edges, val_edges_false, test_edges, test_edges_false
